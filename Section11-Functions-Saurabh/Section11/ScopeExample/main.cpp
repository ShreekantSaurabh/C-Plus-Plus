...
int num {300};    // Global variable - declared outside any class or function. It can be changed any function globally and it retains that new changed value.
...
void static_local_example() {
    static int num {5000};      // static variable retains its intermediate new value between calls locally.
