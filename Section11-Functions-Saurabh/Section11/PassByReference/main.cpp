// Section 11
// Pass-by-reference
//Pass-by-reference pass the reference of an argument in the calling function to the corresponding formal parameter of the called function. 
...
//When the called function read or write the formal parameter, it is actually read or write the argument itself.
...
void pass_by_ref4(const int &numbr);
...
void pass_by_ref4(const int &numbr) {
    const_cast<int&>(numbr) = 3000;
    cout<<"To modify a reference that is qualified by the const qualifier, you must cast away its constness with the const_cast operator"<<endl;
}
...
int main() {
    ...
    cout << "num before calling pass_by_ref4: " << num << endl;
    pass_by_ref4(nm);
    cout << "num after calling pass_by_ref4: " << num << endl;
